				...
				<li>
					<div class="w3_agile_class_grid">
						<div class="w3layouts_team_grid agileits_w3layouts_class">
							...
							<div class="w3layouts_team_grid_pos">
								<div class="wthree_text">
									<a class="agile_class" href="#" data-toggle="modal" data-target="#myModal">Read More</a>
								</div>
							</div>
						...
						<div class="w3_agileits_class_grid">	
							<p class="blog-excerpt">Maecenas volutpat condimentum nisl sed aliquet. Vestibulum non nunc purus</p>
							<h4 id="title"><a href="#" data-toggle="modal" data-target="#myModal">ultricies libero lobortis</a></h4>
							<h5>Homer Simpson</h5>
