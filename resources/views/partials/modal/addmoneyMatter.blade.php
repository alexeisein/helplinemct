<div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 20000">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center" style="background-color: lightblue;">
            	<div class="panel-heading">
					<div class="col-lg-8 text-left">
						<span class="modal-title w-80"><i class="fa fa-pen"></i> Add More Money Matters</span>
					</div>
					<div class="col-lg-3">
						<span><a class="btn btn-info btn-sm" href="{{ route('moneymatter.index') }}"><i class="fa fa-arrow-circle-left"></i> BACK</a></span>
					</div>
		    ...
		    <form action="{{ route('moneymatter.store') }}" method="post">
		     {{ csrf_field() }}
		        <div class="modal-body mx-3">
		            <div class="md-form mb-5{{ $errors->has('name') ? ' has-error' : '' }}">
		                <i class="fas fa-building prefix grey-text"></i>
		                <label data-error="wrong" data-success="right" for="form34">Money Matters Name</label>
				...
				{{-- Hospital ID --}}
		            <div class="md-form mb-5{{ $errors->has('hospital_id') ? ' has-error' : '' }}">
		                ...
		                <label data-error="wrong" data-success="right" for="hospital_id">Hospital Money Matters Created For</label>
...
<div class="text-center">
    <a href="" class="btn btn-primary btn-rounded mb-4 btn-lg" data-toggle="modal" data-target="#modalContactForm">Add Money Matter</a>
</div>