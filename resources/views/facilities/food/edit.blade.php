...
@section('content')
	...
	{{-- Navigation --}}
	<div style="margin-top: 200px;"><h1 class="text-center" style="font-family:'Helvetica neue'; font-weight: lighter; "><i class="fa fa-utensils text-success"></i> Food</h1><hr></div><br>
	...
	<div class="col-lg-11">
		...
		<div class="panel panel-info" id="form-body">
			<div class="panel-heading">
				<span class="col-lg-6"><i class="fa fa-map-marker-alt"></i> LIST OF FOODS</span>
				<span class="col-lg-2 col-lg-offset-4"><a class="btn btn-info btn-sm" href="{{ route('food.index') }}"><i class="fa fa-arrow-circle-left"></i> BACK</a></span>
					...
					<tr>
						<form action="{{ route('food.update', $food->id) }}" method="post">
							...
							<td class="{{ $errors->has('name') ? ' has-error' : '' }} col-lg-3">
								<input type="text" class="form-control" size="100%" name="name" value="{{ old('name', $food->name) }}">
								@if ($errors->has('name'))
