...
@section('content')	
	...
	<div id="page">
		<div id="fh5co-aside" style="background-image:url('/blog/images/image_2.jpg')" data-stellar-background-ratio="0.5">
			...
			<div class="page-title">
				<img src="{{ asset('/blog/images/person_1.jpg') }}" alt="">
	...
	<div class="fh5co-navigation">
		<div class="fh5co-cover prev fh5co-cover-sm" style="background-image: url('/blog/images/project-4.jpg')">
			<div class="overlay"></div>
		...
		<div class="fh5co-cover next fh5co-cover-sm" style="background-image:url('/blog/images/project-5.jpg')">
			<div class="overlay"></div>
			<a class="copy" href="#">
				<div class="display-t">
					<div class="display-tc">
	...
	<footer>
		<div>
			&copy; 2014 Helpline Medical Care &amp; Tour. All rights reserved. Designed by <a href="#" target="_blank">Alexeis Ola</a>  
			{{-- <a href="#" target="_blank">HelplineMedicalCare.com</a> --}}
		</div>
	</footer>
